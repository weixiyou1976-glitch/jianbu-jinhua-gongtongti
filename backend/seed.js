...
const skills = [
  {
    ...
    step_one: '停下来，问自己："如果这个烦躁是一句话，它想说什么？"',
    step_two: '把浮现的第一反应写成一句完整的话，不修饰、不评判',
    step_three: '在这句话后面追问一次"所以呢？"，直到出现一个可以行动的具体动词',
    memory_anchor: '模糊是情绪的伪装，具体是问题的原形',
    insight: '大多数人处理不了"烦躁"本身，是因为烦躁不是一个可以被处理的对象——它是一堆未被命名的信号的集合。当我们停留在"我很烦"这个层面时，大脑没有抓手，只能在情绪里打转。而一旦把烦躁翻译成一句具体的话，比如"我烦是因为那封邮件我不知道该怎么回"，问题就从"情绪"降落到了"任务"，大脑才有了可以处理的对象。',
    case_study: '一位学员连续三天在深夜感到莫名烦躁，用这个方法追问后发现，真正的问题是"我答应了周五交稿，但我不确定自己写的方向对不对，又不敢去问"。把它写清楚之后，第二天她主动去和对方确认了方向，烦躁感当天就消失了——问题从来不是"情绪太多"，而是"那句该问的话一直没问出口"。',
    cognitive_reframe: '你不需要"控制情绪"，你需要的是"给情绪一个名字"。情绪管理的第一步从来不是压制，而是翻译。',
  },
  {
    week_number: 2,
